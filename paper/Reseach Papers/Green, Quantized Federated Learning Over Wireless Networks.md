...
This paper is relevant to our survey because it shows that it is possible to redesign the AI training systems to improve the energy consumption of the systems.

## 3. Critical Comment

It is not clear whether the quantization approach may compromise the accuracy of the models in complex learning tasks.

## 4. AI Disclosure

The methodology interpretation was supported by AI tools, and the summary was written by the author.
